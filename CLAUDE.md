...
- **Tests**: `npm test` (Playwright, 10 algorithm assertions + 11 Pinpoint, ~18s)
...
A self-contained geography game served at `/pinpoint/` (five files, no build
...
- `meta.js` — `{ mapName: [iso2, hook] }`: flag code (flagcdn.com image) and a
